...
export const koChampionDict = {
  ...
  볼리베어: [
    ['볼리베어', '볼리비아'],
    ['볼베', '돌배', '불백', '볼매', '볼 배', '보내', '볼배', '보배', '볼래', '월배', '콜벳', '콜백', '골배', '올백', '보내 줘', '보이넷', '골뱅이', '콜밴', '보이네', '볼펜', '본래'],
  ],
  ...
  카서스: ['카서스', '5세', '갓어스', '카스', '갓쎄', '카사스', '카사 3', '카 3', '5 3', '가서 쓸', '카셀'],
  카시오페아: [
    ['카시오페아'],
    ['카시', '가시', '카카시', '갓이', '카쉬', '카시나'],
  ],
...
export const koActionDict = {
  ...
  SummonerHeal: ['노힐', '노딜', '노일', '노빌', '노 힐', '노엘', '로힐', '노 일', '또 힐', '노 1', '노해일', '노후 1', '놓일', '노후 일', '모힐', '노실', '노트 1', '너 힐', '노회', '놀릴', '노릴', '노희', '노회 일', '노희 일', '로엘', '도희', '로희', '노희 1', '노회 1', 'lol'],
  SummonerDot: ['노점화', '너 담화', '노 담화', '노정화', '노담 화', '노선화', '노 전화', '노담 와', '너 잠 와', '노성화', '너 전화', '노점 화', '농담 화', '로담 화', '노점 와', '노던 화', '농담 와', '노잼 화', '로담 와', '로 전화', '노던 와'],
  SummonerBoost: ['노정화', '노성화', '노정아', '도정화', '조정화', '도성아', '소정화', '조정아', '조성아', '소정아', '도장 와', '또 정화', '서정화', '오정화', '두정아', '도 정화', '조성화', '조성하', '도정 와', '효정아', '호정아', '또 전화', '동화'],
  SummonerTeleport: ['노텔', '노태', '로테', '로텔', '호텔', '로태', '루태', '노태우', '노보텔', '노텍', '로텍', '모텔', '로지텍', '로템'],
  SummonerExhaust: ['노탈진', '너 탈젠', '너 탈진', '노 탈젠', '로탈 잼', '노탈 잼', '노트 8 젠', '모탈 잼', '노 탈 잼', '너 탈 잼', '노털 잼', '못할 잼', '노타이 잼', '로탈 젬', '노트 8 잼', '노탈 젬', '노털 젬', '노트 8 짐', '로타리 잼', '노트 8 10', '노털 젠', '못 할 잼', '노트 8 진', '노트 8 cm', '노트 탈젠', '노탈 젠', '노트 8 재생', '못할 젠', '노트에 잼', '로탈 젠'],
  SummonerFlash: ['노플', '도플', '노페', '어플', '녹색', '로페', '독해', '노팬', '노페인', '독채', '독재', '도배', '노트 8', '뷔페', '노 페인', '도팽', '독백', '녹스', '도쿄', '높여', '독뱀', '노펜', '녹화해', '노캡', '높이', '노벨', '높을'],
